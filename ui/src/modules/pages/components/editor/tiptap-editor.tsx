    import { useEditor, EditorContent, type JSONContent, useEditorState } from "@tiptap/react";
        ...
        <div className="flex flex-col gap-4 w-full max-w-4xl mx-auto relative">
          {editable && (
            <>
              ...
              {editor && (
                <BubbleMenu editor={editor} resizeDelay={100} className="flex bg-background border rounded-md shadow-md p-1 gap-1">
                  <Button
                    variant="ghost"
                    size="sm"
              ...
              {editor && (
                <FloatingMenu editor={editor} className="flex bg-background border rounded-md shadow-md p-1 gap-1">
                  <Button
                    variant="ghost"
                    size="sm"
              ...
              {/* Main Toolbar (Sticky) */}
              <div className="flex flex-wrap gap-2 border-b pb-4 sticky top-0 bg-background z-10 items-center">
